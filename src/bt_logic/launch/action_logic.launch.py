...
def generate_launch_description():
    ...
    return LaunchDescription([
        # --- [ACTION_NODES_MARKER] ---
        Node(package='bt_logic', executable='move_to_pose_node', name='move_to_pose_node', output='screen', parameters=[config_path]),
        Node(package='bt_logic', executable='set_face_expression_node', name='set_face_expression_node', output='screen'),
